...
# 6. 구조체와 사용자 정의 자료형
* 이 강의가 끝난 후에 C++로 넘어간 후, MFC를 배워서 Windows 에서 돌아가는 것들을 만드는 것을 하자. 그런 후에 혼자서 패키지를 만드는 것을 목표로 하자.

* MFC programming 후에 c#로 쉬운 애플리케이션을 만드는 것을 하자
* 급하지 말고, 실망하지 말고, 즐거운 프로그래밍을 하자.
